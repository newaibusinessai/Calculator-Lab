...
const calculator = getCalculatorBySlug("molarity-calculator")!;
    ...
    <CalculatorLayout calculator={calculator}>
      <div className="space-y-6">
        ...
        <div className="mt-6 bg-gray-50 p-4 rounded-lg text-sm text-gray-600">
          <h3 className="font-semibold text-gray-800 mb-2">About Molarity Calculator</h3>
          <p>Solution molarity.</p>
        </div>
      </div>
    </CalculatorLayout>
  );
